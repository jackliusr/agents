...
def tavily_search(
    ...
    """
    search_results = tavily_client.search(query=query, max_results=max_results, topic=topic)
    result_texts = []
...
model = init_chat_model(model="ollama:qwen3.6:35b-a3b-q4_K_M", temperature=0.0)
